...
[Cooling, Heating, Fan_Power,Tzone,Twall,Damper] = building_profile(building,Date,B_loads.InternalGains,ExternalGains,Tdb,RH,Ti,Ti);
...
dt = [dt(1);dt(1);dt];
[Tzone_S,Twall_S] = building_simulate(building,Tdb,RH,dt,B_loads.InternalGains,ExternalGains,Cooling, Heating,AirFlow,Damper,Tzone(1),Twall(1));
