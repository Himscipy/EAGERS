function SG = SolarGain(Build,Date,Location,Weather)
%% Solar gain
nD = length(Date);
or = Build.VariableStruct.Orientation;
sgDiffuse = Build.VariableStruct.WallArea*Weather.irradDiffHorz;%Diffuse irradiance (W)
[SG.Sunrise, SG.Sunset, azimuth, zenith] = SolarCalc(Location.Longitude, Location.Latitude, Location.TimeZone, Date);
