...
global DateSim TestData
if isfield(TestData,'RealTimeData')
    TestData = rmfield(TestData,'RealTimeData');
end
timestamp = (DateSim:Tfreq/24/3600:(DateSim+Duration))';
...
TestData.RealTimeData = interpData;